        ...
        imageViewSendMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Message message = new Message(
                        editTextMessage.getText().toString(), currentUserId, otherUserId);
    ...
    private void observeViewModel() {
        ...
        viewModel.getOtherUser().observe(this, new Observer<User>() {
            ...
            public void onChanged(User user) {
                String infoUser = String.format("%s %s", user.getName(), user.getLastName());
                textViewTitle.setText(infoUser);
                int bgRes;
                if (user.isOnline()) {
                ...
                Drawable drawable = ContextCompat.getDrawable(ChatActivity.this, bgRes);
                viewOnlineStatus.setBackground(drawable);
            }
        });
    }
